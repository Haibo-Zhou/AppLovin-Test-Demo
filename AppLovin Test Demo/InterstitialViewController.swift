...
class InterstitialViewController: UIViewController {
    ...
    func setViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            playAgainButton.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.36),
//            playAgainButton.heightAnchor.constraint(equalTo: playAgainButton.widthAnchor, multiplier: 0.5)
        ])
    }
...
//        updateTimeLeft()
    ...
    fileprivate func loadInterstitial() {
        // load ad
        ALAdMob.shared.createInterstitialAd()
    }
    ...
    fileprivate func endGame() {
        ...
        let alertAction = UIAlertAction(
            ...
            handler: { [weak self] action in
                ...
                if let ad = ALAdMob.shared.interstitialAd {
                    ad.show()
                } else {
